...
void JPAFieldConvection::calc(JPAEmitterWorkData* work, JPAFieldBlock* block, JPABaseParticle* ptcl) {
...
JPAFieldBlock::JPAFieldBlock(u8 const* data, JKRHeap* heap) : mpData((const JPAFieldBlockData*)data) {
    init(heap);
}
