...
J2DPrint::J2DPrint(JUTFont* pFont, f32 charSpacing, f32 lineSpacing, JUtility::TColor charColor, JUtility::TColor gradColor, JUtility::TColor blackColor, JUtility::TColor whiteColor) {
...
void J2DPrint::private_initiate(JUTFont* pFont, f32 charSpacing, f32 lineSpacing, JUtility::TColor charColor, JUtility::TColor gradColor, JUtility::TColor blackColor, JUtility::TColor whiteColor, bool param_7) {
    if (mStrBuff == NULL) {
        setBuffer(0x400);
    }
...
f32 J2DPrint::parse(const u8* pString, int length, int param_2, u16* param_3, TSize& size, u8 alpha, bool param_6) {
    if (mFont == NULL) {
        return 0.0f;
    }
