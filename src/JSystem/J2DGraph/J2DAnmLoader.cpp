...
void J2DAnmKeyLoader_v15::setAnmTransform(J2DAnmTransformKey* p_anm, J3DAnmTransformKeyData const* p_data) {
...
void J2DAnmKeyLoader_v15::setAnmTextureSRT(J2DAnmTextureSRTKey* p_anm, J3DAnmTextureSRTKeyData const* p_data) {
...
void J2DAnmKeyLoader_v15::setAnmColor(J2DAnmColorKey* p_anm, J3DAnmColorKeyData const* p_data) {
    ...
    p_anm->mInfoTable = JSUConvertOffsetToPtr<J3DAnmColorKeyTable>(p_data, (void*)p_data->mTableOffset);
    ...
    p_anm->mUpdateMaterialID = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mUpdateMaterialIDOffset);
    p_anm->field_0x20.setResource(JSUConvertOffsetToPtr<ResNTAB>(p_data, (void*)p_data->mNameTabOffset));
}
...
void J2DAnmKeyLoader_v15::setAnmVtxColor(J2DAnmVtxColorKey* p_anm, J3DAnmVtxColorKeyData const* p_data) {
    p_anm->mFrameMax = p_data->mFrameMax;
    p_anm->field_0x4 = p_data->field_0x8;
    p_anm->mFrame = 0;
    p_anm->mAnmTableNum[0] = p_data->mAnmTableNum[0];
    p_anm->mAnmTableNum[1] = p_data->mAnmTableNum[1];
    p_anm->mInfoTable[0] = JSUConvertOffsetToPtr<J3DAnmColorKeyTable>(p_data, (void*)p_data->mTableOffsets[0]);
    p_anm->mInfoTable[1] = JSUConvertOffsetToPtr<J3DAnmColorKeyTable>(p_data, (void*)p_data->mTableOffsets[1]);
    p_anm->mVtxColorIndexData[0] = JSUConvertOffsetToPtr<J3DAnmVtxColorIndexData>( p_data, (void*)p_data->mVtxColoIndexDataOffset[0]);
    p_anm->mVtxColorIndexData[1] = JSUConvertOffsetToPtr<J3DAnmVtxColorIndexData>( p_data, (void*)p_data->mVtxColoIndexDataOffset[1]);
    p_anm->mVtxColorIndexPointer[0] = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mVtxColoIndexPointerOffset[0]);
    p_anm->mVtxColorIndexPointer[1] = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mVtxColoIndexPointerOffset[1]);
    p_anm->mRValues = JSUConvertOffsetToPtr<s16>(p_data, (void*)p_data->mRValOffset);
    p_anm->mGValues = JSUConvertOffsetToPtr<s16>(p_data, (void*)p_data->mGValOffset);
    p_anm->mBValues = JSUConvertOffsetToPtr<s16>(p_data, (void*)p_data->mBValOffset);
    p_anm->mAValues = JSUConvertOffsetToPtr<s16>(p_data, (void*)p_data->mAValOffset);
...
void J2DAnmFullLoader_v15::setResource(J2DAnmBase* p_anm, void const* p_data) {
    ...
    for (s32 i = 0; i < hdr->mCount; i++) {
        ...
        case 'ANF1':
            if (p_anm->getKind() == KIND_TRANSFORM) {
                setAnmTransform((J2DAnmTransformFull*)p_anm, (J3DAnmTransformFullData*)dataPtr);
            }
            break;
        case 'PAF1':
            if (p_anm->getKind() == KIND_COLOR) {
        ...
        case 'VAF1':
            if (p_anm->getKind() == KIND_VISIBILITY) {
                setAnmVisibility((J2DAnmVisibilityFull*)p_anm, (J3DAnmVisibilityFullData*)dataPtr);
            }
            break;
        case 'VCF1':
            if (p_anm->getKind() == KIND_VTX_COLOR) {
...
void J2DAnmFullLoader_v15::setAnmTransform(J2DAnmTransformFull* p_anm, J3DAnmTransformFullData const* p_data) {
    p_anm->field_0x22 = p_data->field_0xc;
    p_anm->mFrameMax = p_data->mFrameMax;
    p_anm->field_0x4 = p_data->field_0x8;
    p_anm->mFrame = 0;
    p_anm->mTableInfo = JSUConvertOffsetToPtr<J3DAnmTransformFullTable>(p_data, (void*)p_data->mTableOffset);
    p_anm->mScaleValues = JSUConvertOffsetToPtr<f32>(p_data, (void*)p_data->mScaleValOffset);
    p_anm->mRotationValues = JSUConvertOffsetToPtr<s16>(p_data, (void*)p_data->mRotValOffset);
...
void J2DAnmFullLoader_v15::setAnmColor(J2DAnmColorFull* p_anm, J3DAnmColorFullData const* p_data) {
    ...
    p_anm->mFrame = 0;
    p_anm->mUpdateMaterialNum = p_data->mUpdateMaterialNum;
    p_anm->mInfoTable = JSUConvertOffsetToPtr<J3DAnmColorFullTable>(p_data, (void*)p_data->mTableOffset);
...
void J2DAnmFullLoader_v15::setAnmTexPattern(J2DAnmTexPattern* p_anm, J3DAnmTexPatternFullData const* p_data) {
    p_anm->mFrameMax = p_data->mFrameMax;
    p_anm->field_0x4 = p_data->field_0x8;
    p_anm->mFrame = 0;
    p_anm->mUpdateMaterialNum = p_data->field_0xc;
    p_anm->field_0x18 = p_data->field_0xe;
    p_anm->mAnmTable = JSUConvertOffsetToPtr<J3DAnmTexPatternFullTable>(p_data, (void*)p_data->mTableOffset);
...
void J2DAnmKeyLoader_v15::setAnmTevReg(J2DAnmTevRegKey* p_anm, J3DAnmTevRegKeyData const* p_data) {
    ...
    p_anm->mAnmCRegKeyTable = JSUConvertOffsetToPtr<J3DAnmCRegKeyTable>(p_data, (void*)p_data->mCRegTableOffset);
    p_anm->mCRegUpdateMaterialID = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mCRegUpdateMaterialIDOffset);
    p_anm->mCRegNameTab.setResource( JSUConvertOffsetToPtr<ResNTAB>(p_data, (void*)p_data->mCRegNameTabOffset));
    p_anm->mKRegUpdateMaterialNum = p_data->mKRegUpdateMaterialNum;
    p_anm->mAnmKRegKeyTable = JSUConvertOffsetToPtr<J3DAnmKRegKeyTable>(p_data, (void*)p_data->mKRegTableOffset);
    p_anm->mKRegUpdateMaterialID = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mKRegUpdateMaterialIDOffset);
    p_anm->mKRegNameTab.setResource(JSUConvertOffsetToPtr<ResNTAB>(p_data, (void*)p_data->mKRegNameTabOffset));
...
void J2DAnmFullLoader_v15::setAnmVisibility(J2DAnmVisibilityFull* p_anm, J3DAnmVisibilityFullData const* p_data) {
    p_anm->mFrameMax = p_data->mFrameMax;
    p_anm->field_0x4 = p_data->field_0x8;
    p_anm->mFrame = 0;
    p_anm->field_0x10 = p_data->field_0xc;
    p_anm->field_0x12 = p_data->field_0xe;
    p_anm->mTable = JSUConvertOffsetToPtr<J3DAnmVisibilityFullTable>(p_data, (void*)p_data->mTableOffset);
...
void J2DAnmFullLoader_v15::setAnmVtxColor(J2DAnmVtxColorFull* p_anm, J3DAnmVtxColorFullData const* p_data) {
    p_anm->mFrameMax = p_data->mFrameMax;
    p_anm->field_0x4 = p_data->field_0x8;
    p_anm->mFrame = 0;
    p_anm->mAnmTableNum[0] = p_data->mAnmTableNum[0];
    p_anm->mAnmTableNum[1] = p_data->mAnmTableNum[1];
    p_anm->mInfoTable[0] = JSUConvertOffsetToPtr<J3DAnmColorFullTable>(p_data, (void*)p_data->mTableOffsets[0]);
    p_anm->mInfoTable[1] = JSUConvertOffsetToPtr<J3DAnmColorFullTable>(p_data, (void*)p_data->mTableOffsets[1]);
    p_anm->mVtxColorIndexData[0] = JSUConvertOffsetToPtr<J3DAnmVtxColorIndexData>(p_data, (void*)p_data->mVtxColorIndexDataOffsets[0]);
    p_anm->mVtxColorIndexData[1] = JSUConvertOffsetToPtr<J3DAnmVtxColorIndexData>(p_data, (void*)p_data->mVtxColorIndexDataOffsets[1]);
    p_anm->mVtxColorIndexPointer[0] = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mVtxColorIndexPointerOffsets[0]);
    p_anm->mVtxColorIndexPointer[1] = JSUConvertOffsetToPtr<u16>(p_data, (void*)p_data->mVtxColorIndexPointerOffsets[1]);
    p_anm->mRValues = JSUConvertOffsetToPtr<u8>(p_data, p_data->mRValuesOffset);
    p_anm->mGValues = JSUConvertOffsetToPtr<u8>(p_data, p_data->mGValuesOffset);
    p_anm->mBValues = JSUConvertOffsetToPtr<u8>(p_data, p_data->mBValuesOffset);
    p_anm->mAValues = JSUConvertOffsetToPtr<u8>(p_data, p_data->mAValuesOffset);
