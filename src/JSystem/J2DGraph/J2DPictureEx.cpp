...
J2DPictureEx::J2DPictureEx(J2DPane* param_0, JSURandomInputStream* param_1, u32 param_2, J2DMaterial* param_3) {
    field_0x194 = 0;
    field_0x198 = 0;
...
void J2DPictureEx::drawFullSet(f32 param_0, f32 param_1, f32 param_2, f32 param_3, f32 (*param_4)[3][4]) {
...
void J2DPictureEx::drawTexCoord(f32 param_0, f32 param_1, f32 param_2, f32 param_3, s16 param_4, s16 param_5, s16 param_6, s16 param_7, s16 param_8, s16 param_9, s16 param_10, s16 param_11, f32 (*param_12)[3][4]) {
...
bool J2DPictureEx::insert(ResTIMG const* param_0, JUTPalette* param_1, u8 param_2, f32 param_3) {
    if (param_0 == NULL) {
        return false;
    }
...
void J2DPictureEx::draw(f32 param_0, f32 param_1, u8 texNo, bool param_3, bool param_4, bool param_5) {
    if (mMaterial == NULL) {
        return;
    }
...
void J2DPictureEx::draw(f32 param_0, f32 param_1, f32 width, f32 height, bool param_4, bool param_5, bool param_6) {
    if (!isVisible()) {
        return;
    }
...
void J2DPictureEx::drawOut(f32 param_0, f32 param_1, f32 param_2, f32 param_3, f32 param_4, f32 param_5) {
    if (mMaterial == NULL) {
        return;
    }
    ...
    if (texture != NULL) {
        drawOut(JGeometry::TBox2<f32>(param_0, param_1, param_0 + param_2, param_1 + param_3), JGeometry::TBox2<f32>(param_4, param_5, param_4 + texture->getWidth(), param_5 + texture->getHeight()));
    }
}

void J2DPictureEx::drawOut(JGeometry::TBox2<f32> const& param_0, JGeometry::TBox2<f32> const& param_1) {
    if (mMaterial == NULL) {
        return;
    }
