...
J2DWindow::J2DWindow() : field_0x100(NULL), field_0x104(NULL), field_0x108(NULL), field_0x10c(NULL), field_0x110(NULL), mPalette(NULL) {
    field_0x144 = 0;
...
J2DWindow::J2DWindow(J2DPane* param_0, JSURandomInputStream* param_1, JKRArchive* param_2) : field_0x100(NULL), field_0x104(NULL), field_0x108(NULL), field_0x10c(NULL), field_0x110(NULL), mPalette(NULL) {
...
void J2DWindow::private_readStream(J2DPane* param_0, JSURandomInputStream* param_1, JKRArchive* param_2) {
...
void J2DWindow::draw_private(JGeometry::TBox2<f32> const& param_0, JGeometry::TBox2<f32> const& param_1) {
    ...
    if (field_0x100 && field_0x104 && field_0x108 && field_0x10c) {
        ...
        drawFrameTexture(field_0x104, f27, f28, f31 - f27, field_0x104->getHeight(), r29, r28, r27, r26, false);
        r24 = field_0x145 & 2;
        ...
        r26 = r28 ^ 0x8000;
        drawFrameTexture(field_0x10c, f27, f30, f31 - f27, field_0x10c->getHeight(), r29, r28, r27, r26, false);
        r29 = field_0x144 & 2 ? u16(0) : u16(0x8000);
        r27 = r29 ^ 0x8000;
        r26 = field_0x144 & 1 ? u16(0x8000) : u16(0);
        r28 = r26;
        drawFrameTexture(field_0x10c, f31, f26, field_0x10c->getWidth(), f30 - f26, r29, r28, r27, r26, false);
        r24 = field_0x145 & 4;
        ...
        r28 = r26;
        drawFrameTexture(field_0x108, f29, f26, field_0x108->getWidth(), f30 - f26, r29, r28, r27, r26, false);
    }
...
void J2DWindow::setContentsColor(JUtility::TColor param_0, JUtility::TColor param_1, JUtility::TColor param_2, JUtility::TColor param_3) {
...
void J2DWindow::drawFrameTexture(JUTTexture* param_0, f32 param_1, f32 param_2, f32 param_3, f32 param_4, u16 param_5, u16 param_6, u16 param_7, u16 param_8, bool param_9) {
...
void J2DWindow::drawFrameTexture(JUTTexture* param_0, f32 param_1, f32 param_2, bool param_3, bool param_4, bool param_5) {
    u16 r31, r30, r29, r28;
    if (param_4) {
        r31 = 0x8000;
    } else {
    ...
    drawFrameTexture(param_0, param_1, param_2, param_0->getWidth(), param_0->getHeight(), r28, r29, r30, r31, param_5);
}
...
void J2DWindow::setTevMode(JUTTexture* param_0, JUtility::TColor param_1, JUtility::TColor param_2) {
