...
void dComIfG_play_c::init() {
    std::cout << "dComIfG_play_c::init() is stubbed" << std::endl;
...
void dComIfG_play_c::itemInit() {
    std::cout << "dComIfG_play_c::itemInit() is stubbed" << std::endl;
...
void dComIfG_get_timelayer(int* o_layer) {
    std::cout << "dComIfG_get_timelayer() is stubbed" << std::endl;
...
int dComIfG_play_c::getLayerNo_common_common(const char* i_stageName, int i_roomNo, int o_layer) {
    std::cout << "dComIfG_play_c::getLayerNo_common_common() is stubbed" << std::endl;
...
BOOL dComIfG_resetToOpening(scene_class* i_scene) {
    std::cout << "dComIfG_resetToOpening() is stubbed" << std::endl;
...
static int phase_1(char* i_arcName) {
    std::cout << "phase_1() is stubbed" << std::endl;
...
static int phase_2(char* i_arcName) {
    std::cout << "phase_2() is stubbed" << std::endl;
...
static int phase_01(phaseParam_c* i_phasePrm) {
    std::cout << "phase_01() is stubbed" << std::endl;
...
static int phase_02(phaseParam_c* i_phasePrm) {
    std::cout << "phase_02() is stubbed" << std::endl;
...
int dComIfG_resDelete(request_of_phase_process_class* i_phase, char const* i_resName) {
    std::cout << "dComIfG_resDelete() is stubbed" << std::endl;
...
s8 dComIfGp_getReverb(int i_roomNo) {
    std::cout << "dComIfGp_getReverb() is stubbed" << std::endl;

    return -1; // dStage_roomRead_dt_c_GetReverbStage(*dComIfGp_getStageRoom(), i_roomNo);
}
...
stage_camera_class* dComIfGp_getRoomCamera(int i_roomNo) {
    std::cout << "dComIfGp_getRoomCamera() is stubbed" << std::endl;
...
stage_arrow_class* dComIfGp_getRoomArrow(int i_roomNo) {
    std::cout << "dComIfGp_getRoomArrow() is stubbed" << std::endl;
...
void dComIfGp_setNextStage(char const* i_stage, s16 i_point, s8 i_roomNo, s8 i_layer,
    ...
    std::cout << "dComIfGp_setNextStage() is stubbed" << std::endl;
...
BOOL dComIfGs_isStageTbox(int i_stageNo, int i_no) {
    std::cout << "dComIfGs_isStageTbox() is stubbed" << std::endl;
...
void dComIfGs_onStageSwitch(int i_stageNo, int i_no) {
    std::cout << "dComIfGs_onStageSwitch() is stubbed" << std::endl;
...
void dComIfGs_offStageSwitch(int i_stageNo, int i_no) {
    std::cout << "dComIfGs_offStageSwitch() is stubbed" << std::endl;
...
BOOL dComIfGs_isStageSwitch(int i_stageNo, int i_no) {
    std::cout << "dComIfGs_isStageSwitch() is stubbed" << std::endl;
...
void dComIfGs_onStageBossEnemy(int i_stageNo) {
    std::cout << "dComIfGs_onStageBossEnemy() is stubbed" << std::endl;
...
s32 dComIfGs_isDungeonItemWarp(int i_stageNo) {
    std::cout << "dComIfGs_isDungeonItemWarp() is stubbed" << std::endl;
...
void dComIfGs_offZoneSwitch(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_offZoneSwitch() is stubbed" << std::endl;
...
BOOL dComIfGs_isZoneSwitch(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_isZoneSwitch() is stubbed" << std::endl;
...
void dComIfGs_onOneZoneSwitch(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_onOneZoneSwitch() is stubbed" << std::endl;
...
void dComIfGs_offOneZoneSwitch(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_offOneZoneSwitch() is stubbed" << std::endl;
...
BOOL dComIfGs_isOneZoneSwitch(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_isOneZoneSwitch() is stubbed" << std::endl;
...
BOOL dComIfGs_isZoneItem(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_isZoneItem() is stubbed" << std::endl;
...
BOOL dComIfGs_isOneZoneItem(int i_swBit, int i_roomNo) {
    std::cout << "dComIfGs_isOneZoneItem() is stubbed" << std::endl;
...
u8 dComIfGs_getSelectMixItemNoArrowIndex(int i_selmixItemIdx) {
    std::cout << "dComIfGs_getSelectMixItemNoArrowIndex() is stubbed" << std::endl;
...
u8 dComIfGp_getSelectItem(int i_selItemIdx) {
    std::cout << "dComIfGp_getSelectItem() is stubbed" << std::endl;
...
void dComIfGp_mapShow() {
    std::cout << "dComIfGp_mapShow() is stubbed" << std::endl;
    // dComIfGs_offEventBit(dSv_event_flag_c::MAP_VISIBLE);
}

void dComIfGp_mapHide() {
    std::cout << "dComIfGp_mapHide() is stubbed" << std::endl;
    // dComIfGs_onEventBit(dSv_event_flag_c::MAP_VISIBLE);
}

bool dComIfGp_checkMapShow() {
    std::cout << "dComIfGp_checkMapShow() is stubbed" << std::endl;
    return false; // !dComIfGs_isEventBit(dSv_event_flag_c::MAP_VISIBLE);
}
...
u8 dComIfGs_checkGetInsectNum() {
    std::cout << "dComIfGs_checkGetInsectNum() is stubbed" << std::endl;
...
u8 dComIfGs_checkGetItem(u8 i_itemNo) {
    std::cout << "dComIfGs_checkGetItem() is stubbed" << std::endl;
...
s16 dComIfGp_getSelectItemNum(int i_selItemIdx) {
    std::cout << "dComIfGp_getSelectItemNum() is stubbed" << std::endl;
...
int dComIfGp_getSelectItemMaxNum(int i_selItemIdx) {
    std::cout << "dComIfGp_getSelectItemMaxNum() is stubbed" << std::endl;
...
void dComIfGp_setSelectItemNum(int i_selItemIdx, s16 i_num) {
    std::cout << "dComIfGp_setSelectItemNum() is stubbed" << std::endl;
...
void dComIfGp_addSelectItemNum(int i_selItemIdx, s16 i_num) {
    std::cout << "dComIfGp_addSelectItemNum() is stubbed" << std::endl;
...
struct field_data {
    ...
    u8 room_no;
    u8 region_no;
    u8 field_0xa[0x14 - 0xA];
};

void dComIfGp_calcNowRegion() {
    std::cout << "dComIfGp_calcNowRegion() is stubbed" << std::endl;
...
u8 dComIfG_getNowCalcRegion() {
    std::cout << "dComIfG_getNowCalcRegion() is stubbed" << std::endl;
...
u8 dComIfGp_getNowLevel() {
    std::cout << "dComIfGp_getNowLevel() is stubbed" << std::endl;
...
void dComIfGs_setSelectEquipSword(u8 i_itemNo) {
    std::cout << "dComIfGs_setSelectEquipSword() is stubbed" << std::endl;
...
void dComIfGs_setSelectEquipShield(u8 i_itemNo) {
    std::cout << "dComIfGs_setSelectEquipShield() is stubbed" << std::endl;
...
void dComIfGs_setKeyNum(int i_stageNo, u8 i_keyNum) {
    std::cout << "dComIfGs_setKeyNum() is stubbed" << std::endl;
...
void dComIfG_play_c::setWarpItemData(char const* i_stage, cXyz i_pos, s16 i_angle, s8 i_roomNo, u8 param_4, u8 param_5) {
    std::cout << "dComIfG_play_c::setWarpItemData() is stubbed" << std::endl;
...
int dComIfG_TimerStart(int i_mode, s16 i_time) {
    std::cout << "dComIfG_TimerStart() is stubbed" << std::endl;
...
int dComIfG_TimerStop(int i_mode) {
    std::cout << "dComIfG_TimerStop() is stubbed" << std::endl;
...
int dComIfG_TimerReStart(int i_mode) {
    std::cout << "dComIfG_TimerReStart() is stubbed" << std::endl;
...
int dComIfG_TimerEnd(int i_mode, int param_1) {
    std::cout << "dComIfG_TimerEnd() is stubbed" << std::endl;
...
int dComIfG_TimerDeleteCheck(int i_mode) {
    std::cout << "dComIfG_TimerDeleteCheck() is stubbed" << std::endl;
...
int dComIfG_TimerDeleteRequest(int i_mode) {
    std::cout << "dComIfG_TimerDeleteRequest() is stubbed" << std::endl;
...
BOOL dComIfGs_Wolf_Change_Check() {
    std::cout << "dComIfGs_Wolf_Change_Check() is stubbed" << std::endl;
...
BOOL dComIfGs_wolfeye_effect_check() {
    std::cout << "dComIfGs_wolfeye_effect_check() is stubbed" << std::endl;
...
void dComIfGs_staffroll_next_go() {
    std::cout << "dComIfGs_staffroll_next_go() is stubbed" << std::endl;
