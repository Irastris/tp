...
static cXyz relationalPos2(fopAc_ac_c* i_actor1, fopAc_ac_c* i_actor2, cXyz* param_2, f32 param_3, cSAngle param_4) {
...
inline static bool lineCollisionCheck(cXyz param_0, cXyz param_1, fopAc_ac_c* param_2, fopAc_ac_c* param_3, fopAc_ac_c* param_4) {
...
bool dCamera_c::Run() {
    ...
    if ((iVar8 != mIsWolf || mNextMode != mCurMode) && mCamTypeData[mCurType].field_0x18[mIsWolf][mNextMode] >= 0 && onModeChange(mCurMode, mNextMode)) {
        mCurMode = mNextMode;
        mCurCamStyleTimer = 0;
    }
...
bool dCamera_c::talktoCamera(s32 param_0) {
    ...
    switch (sp430) {
        ...
        case 65: {
            ...
            if (lineBGCheck(&sp146C, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp146C, talk->field_0x9c, listener, speaker, NULL)) {
                sp430 = 0;
            } else {
        ...
        case 19: {
            ...
            if (lineBGCheck(&sp1448, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp1448, talk->field_0x9c, listener, speaker, NULL)) {
                sp430 = 0;
            } else {
                mViewCache.mCenter = talk->field_0x90;
                mViewCache.mEye = talk->field_0x9c;
        ...
        case 25: {
            ...
            if (lineBGCheck(&sp3E8, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp3E8, talk->field_0x9c, listener, speaker, NULL)) {
                sp430 = 0;
            } else {
                mViewCache.mCenter = talk->field_0x90;
                mViewCache.mEye = talk->field_0x9c;
        ...
        case 27: {
            ...
            if (lineBGCheck(&sp1418, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp1418, talk->field_0x9c, listener, speaker, NULL)) {
                sp430 = 0;
            } else {
                mViewCache.mCenter = talk->field_0x90;
                mViewCache.mEye = talk->field_0x9c;
        ...
        case 28: {
            ...
            if (lineBGCheck(&sp13B8, &talk->field_0x9c, talk->field_0x8c) || lineBGCheck(&sp13AC, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp13B8, talk->field_0x9c, listener, speaker, NULL) || lineCollisionCheck(sp13AC, talk->field_0x9c, listener, speaker, NULL))
            {
                sp430 = 0;
            } else {
                mViewCache.mCenter = talk->field_0x90;
        ...
        case 29: {
            ...
            if (lineBGCheck(&sp137C, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp137C, talk->field_0x9c, listener, actor1_sp3A0, NULL)) {
                sp430 = 0;
            } else {
                mViewCache.mCenter = talk->field_0x90;
                mViewCache.mEye = talk->field_0x9c;
        ...
        case 36: {
                ...
                || lineCollisionCheck(sp1328, talk->field_0x9c, listener, speaker, NULL))
            {
                ...
                if (lineBGCheck(&sp1328, &talk->field_0x9c, talk->field_0x8c) || lineCollisionCheck(sp1328, talk->field_0x9c, listener, speaker, NULL)) {
                    sp430 = 0;
                } else {
                    mViewCache.mCenter = talk->field_0x90;
                    mViewCache.mEye = talk->field_0x9c;
    ...
    if (wk->field_0x92 != 0 && wk->field_0x94 != 0) {
        ...
        if (wk->field_0x98 != 0) {
            ...
            if (sp1AC != NULL && fopAcM_GetName(sp1AC) == PROC_E_KR) {
                ...
                if (sp1AC != NULL && (fopAcM_GetName(sp1AC) == PROC_E_RD && (fopAcM_GetParam(sp1AC) & 4) != 0 || fopAcM_GetName(sp1AC) == PROC_B_GND) && sp1A8 == NULL) {
                    if (wk->field_0x93 != 0) {
                        val7 = 550.0f;
                        val2 = -120.0f;
                        val12 = 23.0f;
                    ...
                    if (sp1AC != NULL && (fopAcM_GetName(sp1AC) == PROC_E_RD || fopAcM_GetName(sp1AC) == PROC_E_FK) || sp1A8 != NULL && (fopAcM_GetName(sp1A8) == PROC_E_RD || fopAcM_GetName(sp1A8) == PROC_E_FK) || sp1A4 != NULL)
                    {
                        if (mGear == 1) {
                            val7 -= 1000.0f;
                            val12 += 5.0f;
...
static int camera_draw(camera_process_class* i_this) {
    ...
    mDoMtx_lookAt(process->viewMtx, &process->lookat.eye, &process->lookat.center, &process->lookat.up, process->bank);

    j3dSys.setViewMtx(process->viewMtx);
    cMtx_inverse(process->viewMtx, process->invViewMtx);

    Z2GetAudience()->setAudioCamera(process->viewMtx, process->lookat.eye, process->lookat.center, process->fovy, process->aspect, getComStat(0x80), camera_id, false);
