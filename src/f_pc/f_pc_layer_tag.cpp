...
int fpcLyTg_ToQueue(layer_management_tag_class* i_layer_tag, fpc_ProcID i_layerID, u16 i_listID, u16 i_listPriority) {
    ...
    } else if (fpcLy_IntoQueue(i_layer_tag->layer, i_listID, &i_layer_tag->create_tag, i_listPriority) != 0) {
        i_layer_tag->node_list_id = i_listID;
...
int fpcLyTg_Move(layer_management_tag_class* i_layer_tag, fpc_ProcID i_layerID, u16 i_listID, u16 i_listPriority) {
