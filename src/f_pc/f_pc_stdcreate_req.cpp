...
int fpcSCtRq_phase_CreateProcess(standard_create_request_class* i_request) {
    ...
    i_request->base.process = fpcBs_Create(i_request->process_name, i_request->base.id, i_request->process_append);
...
int fpcSCtRq_phase_IsComplete(standard_create_request_class* i_request) {
    process_node_class* procNode = (process_node_class*)((standard_create_request_class*)i_request)->base.process;
